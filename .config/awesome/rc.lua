...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "l", function ()
      ...
      naughty.notify({ title = 'Master Width Factor', text = tostring(awful.tag.getmwfact()), timeout = 1 })
    end),
    ...
    awful.key({ modkey, "Shift"   }, "h", function ()
      ...
      naughty.notify({ title = 'Master Windows', text = tostring(awful.tag.getnmaster()), timeout = 1 })
    end),
